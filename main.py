...
def load_weather():
    global current_city_text, current_temp_text, weather_desription, current_description_text, list_first_hours_temp, list_first_hours_time
    ...
    frame_hourly_weather = CTkFrame(frame_weather, 820, 240, fg_color = '#096C82')
    frame_hourly_weather.place(x = 50, y = 430)
    print(3)
    ...
    for i in range(8):
        ...
        first_hours_temp.grid(row = 1, column = i, pady = 10, padx = 20)
        list_first_hours_temp.append(first_hours_temp)
        # second_hours_time = CTkLabel(frame_hourly_weather, text = f'{list_weather_time[1]}:00', font = ('Arial', 18), text_color = 'white')
        # second_hours_time.grid(row = 0, column = 1, pady = 10, padx = 10)
        # second_hours_temp = CTkLabel(frame_hourly_weather, text = f'{list_weather_temp[1]}°', font = ('Arial', 26), text_color = 'white')
        # second_hours_temp.grid(row = 1, column = 1, pady = 10, padx = 10)
